        ...
        <div>
            ...
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+254 741433059'} text2={'+254 790385254'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'geomwans@gmail.com'} text2={'geomwans@yahoo.com'} title={'Email'}/>
                    <ContactItem icon={location} text1={'880, Thika'} text2={'Kenya'} title={'Address'}/>
                </div>
            </div>
        </div>
    )
